...
/// It catches any unhandled exceptions and converts them into standardized "Problem Details" (RFC 7807) JSON responses,
/// so the client always receives a consistent and helpful error format.
/// </summary>

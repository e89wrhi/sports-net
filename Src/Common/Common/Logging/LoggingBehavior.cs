...
namespace Sport.Common.Logging;

/// <summary>
/// A MediatR pipeline behavior that logs the execution of every request.
/// It tracks how long each request takes and logs a warning if it exceeds a performance threshold (e.g., 3 seconds).
/// </summary>

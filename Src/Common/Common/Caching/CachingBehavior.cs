...
/// <summary>
/// A MediatR pipeline behavior that automatically caches query responses.
/// It checks if a request implements ICacheRequest and, if so, tries to serve the response from the cache
/// before reaching the actual handler. This significantly improves performance for frequent, read-heavy operations.
/// </summary>

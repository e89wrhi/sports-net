...
/// <summary>
/// A MediatR pipeline behavior that clears cached data whenever a relevant command is executed.
/// It looks for the IInvalidateCacheRequest interface to know which cache key needs to be purged.
/// </summary>

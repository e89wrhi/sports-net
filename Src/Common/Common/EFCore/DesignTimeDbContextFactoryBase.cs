...
/// <summary>
/// A helper used by Entity Framework Core tools (like migrations) to create your DbContext at design time.
/// It knows how to look up your connection string from appsettings.json so you can run 'dotnet ef migrations add' easily.
/// </summary>

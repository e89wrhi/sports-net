...
/// <summary>
/// Infrastructure extensions for setting up JWT Authentication and Authorization.
/// It configures the system to trust tokens from a specific authority (like Keycloak) and defines security policies based on roles and scopes.
/// </summary>

...
/// <summary>
/// A comprehensive configuration object for tuning our system's observability.
/// You can toggle metrics, tracing, and logging individually, and specify which external tools (exporters) to use.
/// </summary>

...
var eventsDb = postgres.AddDatabase("event");
var matchesDb = postgres.AddDatabase("match");
var persistMessageDb = postgres.AddDatabase("persist-message");
var votesDb = postgres.AddDatabase("vote");
...
var api = builder.AddProject<Sport_Api>("api")
    .WithReference(identityDb)
    .WithReference(eventsDb)
    .WithReference(matchesDb)
    .WithReference(persistMessageDb)
    .WithReference(votesDb)
    .WaitFor(identityDb)
    .WaitFor(eventsDb)
    .WaitFor(matchesDb)
